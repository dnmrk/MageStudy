...
return [
    'modules' => [
        ...
        'Nathanjosiah_LayoutDebugger' => 1,
        'Nineteen02_Customer' => 0,
        'Nineteen02_FreeShippingBar' => 0,
        'RLTSquare_AjaxShoppingCartUpdate' => 1,
        'Sparsh_FreeShippingBar' => 1,
        'Temando_ShippingRemover' => 1,
        'Vertex_Tax' => 1,
        'Vertex_AddressValidation' => 1,
        'VinaiKopp_Breakout' => 0,
        'Yotpo_Yotpo' => 1
    ]
];
